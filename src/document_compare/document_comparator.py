...
class DocumentComparatorLLM:
    ...
    def comparator_documents(self,combined_docs:str)->pd.DataFrame:
        try:
            inputs = {
            ...
            return self.__format__response(response)
    ...
    def __format__response(self,response_parsed:list[dict])->pd.DataFrame:
        try:
