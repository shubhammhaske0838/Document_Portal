...
class ModelLoader:
    ...
    def load_validate_env(self):
        ...
        log.info("Environment variable validated",available_keys = [k for k in self.api_keys if self.api_keys[k]])
